...
let OpenOrdersService = class OpenOrdersService {
    async create(dto) {
        const { instrument_id, buy_qty, buy_price, buy_date, market_type, customer_id, sell_placed, reserved_placed, loan_percent } = dto;
    ...
    async update(id, dto) {
        ...
        await pool_1.pool.query(queries_1.queries.UPDATE_OPEN_ORDER, [
            instrument_id, market_type, buy_date, buy_qty, buy_price, customer_id, sell_placed, reserved_placed, loan_percent, id
        ]);
